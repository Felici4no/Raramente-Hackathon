...
import { LayoutDashboard, MapPin, Filter, ArrowRight, Activity, Users, AlertCircle, ShieldCheck, Heart } from 'lucide-react';
  ...
  return (
    <section id="dashboard" className="section" style={{ background: '#FFFFFF', borderTop: '1px solid #EBE7DE' }}>
      <div className="container">
        ...
        <div style={{ background: '#F4F1E8', borderRadius: '24px', padding: '36px 28px', marginBottom: '40px', border: '1px solid #E2DDD3' }}>
          <div style={{ fontWeight: 800, color: '#4A2F1B', fontSize: '0.9rem', letterSpacing: '0.05em', textTransform: 'uppercase', marginBottom: '24px', textAlign: 'center' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px', alignItems: 'center' }}>
            ...
            <div 
              ...
              style={{ 
                ...
                borderRadius: '16px', padding: '20px', cursor: 'pointer', transition: 'all 0.2s', textAlign: 'center'
              }}
            >
              <div style={{ fontSize: '0.78rem', color: '#6B655F', fontWeight: 700 }}>1. POPULAÇÃO ADSTRITA</div>
              <div style={{ fontSize: '1.8rem', fontWeight: 900, color: '#4A2F1B', margin: '4px 0' }}>12.482</div>
              <div style={{ fontSize: '0.75rem', color: '#8B5A2B' }}>Pessoas cadastradas</div>
            </div>

            <div style={{ textAlign: 'center', color: '#8B5A2B', fontWeight: 700 }}>➔</div>
            ...
            >
              <div style={{ fontSize: '0.78rem', color: '#6B655F', fontWeight: 700 }}>2. JORNADAS RECORRENTES</div>
              <div style={{ fontSize: '1.8rem', fontWeight: 900, color: '#2E8B3C', margin: '4px 0' }}>1.804</div>
            ...
            >
              <div style={{ fontSize: '0.78rem', color: '#B45309', fontWeight: 700 }}>3. JORNADAS ATÍPICAS</div>
              <div style={{ fontSize: '1.8rem', fontWeight: 900, color: '#D97706', margin: '4px 0' }}>214</div>
            ...
            >
              <div style={{ fontSize: '0.78rem', color: '#92400E', fontWeight: 800 }}>4. CASOS PRIORITÁRIOS</div>
              <div style={{ fontSize: '1.8rem', fontWeight: 900, color: '#B45309', margin: '4px 0' }}>38</div>
        ...
        <div className="card" style={{ background: '#FAF8F5', border: '1px solid #E2DDD3', padding: '32px', marginBottom: '64px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px', flexWrap: 'wrap', gap: '16px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <MapPin size={22} color="#0B6B2B" />
              <div>
        ...
        <div style={{ 
          ...
          <div style={{ maxWidth: '720px', margin: '0 auto' }}>
            <h2 style={{ fontSize: 'clamp(2rem, 4vw, 3rem)', fontWeight: 800, color: '#FFFFFF', marginBottom: '20px' }}>
              Converta impacto em informação.
            </h2>
            <p style={{ fontSize: '1.2rem', opacity: 0.92, marginBottom: '32px', lineHeight: 1.6 }}>
            ...
            <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap', marginBottom: '36px' }}>
              <a href="#" className="btn" style={{ background: '#FFFFFF', color: '#0B6B2B', padding: '16px 36px', fontSize: '1.05rem', fontWeight: 800 }}>
            ...
            <div style={{ borderTop: '1px solid rgba(255,255,255,0.2)', paddingTop: '24px', fontSize: '0.9rem', opacity: 0.85, fontStyle: 'italic' }}>
