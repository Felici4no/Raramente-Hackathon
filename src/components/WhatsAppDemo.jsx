    ...
    <section id="whatsapp" className="section" style={{ background: '#F4F1E8' }}>
      <div className="container">
        ...
        <div className="grid-2col">
          ...
          <div style={{ background: '#0B141A', borderRadius: '12px', padding: '20px', boxShadow: '0 16px 40px rgba(0,0,0,0.15)', border: '4px solid #2A3942' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '14px', minHeight: '340px' }}>
              ...
              <div style={{ alignSelf: 'flex-end', maxWidth: '92%', background: '#005C4B', color: '#E9EDEF', borderRadius: '8px 8px 2px 8px', padding: '12px 16px' }}>
                <div style={{ fontSize: '0.78rem', color: '#8696A0', marginBottom: '6px', fontWeight: 600 }}>ACS Ana • Visita Domiciliar</div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                  <button 
                    onClick={() => setIsPlaying(!isPlaying)}
                    style={{ width: '36px', height: '36px', borderRadius: '6px', background: '#25D366', border: 'none', color: '#0B141A', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', flexShrink: 0 }}
                  >
                ...
                <p style={{ fontSize: '0.88rem', marginTop: '8px', color: '#E9EDEF', fontStyle: 'italic', background: 'rgba(0,0,0,0.15)', padding: '8px 10px', borderRadius: '4px' }}>
              ...
              <div style={{ alignSelf: 'flex-start', maxWidth: '95%', background: '#202C33', color: '#E9EDEF', borderRadius: '8px 8px 8px 2px', padding: '14px 16px', borderLeft: '3px solid #57B33E' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', marginBottom: '12px' }}>
                  <div style={{ background: 'rgba(87, 179, 62, 0.15)', padding: '6px 10px', borderRadius: '4px', color: '#57B33E', fontSize: '0.85rem', fontWeight: 600 }}>
                ...
                <div style={{ fontStyle: 'italic', background: 'rgba(255,255,255,0.05)', padding: '10px', borderRadius: '6px', borderLeft: '2px solid #8B5A2B', fontSize: '0.88rem' }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              <div className="card" style={{ padding: '20px', display: 'flex', alignItems: 'center', gap: '16px' }}>
                <div style={{ width: '40px', height: '40px', borderRadius: '8px', background: 'rgba(11, 107, 43, 0.1)', color: '#0B6B2B', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 800, flexShrink: 0 }}>1</div>
                <div>
              ...
              <div className="card" style={{ padding: '20px', display: 'flex', alignItems: 'center', gap: '16px' }}>
                <div style={{ width: '40px', height: '40px', borderRadius: '8px', background: 'rgba(46, 139, 60, 0.1)', color: '#2E8B3C', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 800, flexShrink: 0 }}>2</div>
                <div>
              ...
              <div className="card" style={{ padding: '20px', display: 'flex', alignItems: 'center', gap: '16px' }}>
                <div style={{ width: '40px', height: '40px', borderRadius: '8px', background: 'rgba(139, 90, 43, 0.1)', color: '#8B5A2B', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 800, flexShrink: 0 }}>3</div>
                <div>
              ...
              <div className="card" style={{ padding: '20px', display: 'flex', alignItems: 'center', gap: '16px', border: '2px solid #57B33E', background: '#FFFFFF' }}>
                <div style={{ width: '40px', height: '40px', borderRadius: '8px', background: '#57B33E', color: '#FFFFFF', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 800, flexShrink: 0 }}>4</div>
                <div>
