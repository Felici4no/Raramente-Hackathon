      ...
      <div className="container">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '40px', marginBottom: '48px' }}>
          ...
          <div>
            ...
            <p style={{ fontSize: '0.88rem', color: '#B0A8A0', lineHeight: 1.6 }}>
              Inspirado no <em>Nasua nasua</em> (quati), espécie nativa conhecida pela sua curiosidade, forte senso territorial e capacidade de investigação minuciosa.
            </p>
          </div>
        ...
        {/* Rodape Bottom */}
        <div style={{ borderTop: '1px solid #3A322C', paddingTop: '24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '16px', fontSize: '0.85rem', color: '#8B827A' }}>
          <div>
            © 2026 Agente na Sua. Todos os direitos reservados.
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
            Transformamos impacto em informação <Heart size={14} color="#57B33E" fill="#57B33E" style={{ marginLeft: '4px' }} />
          </div>
        </div>
